...
//        dishMapper.updateStatus(status,id);
    ...
    private boolean getDishStatus(Long id) {
        return dishMapper.getDishStatus(id) == 1;
    }

    private boolean getMealCounts(Long id) {
        return setmealDishMapper.getSetmealCountByDishId(id) > 0;
    }
}
